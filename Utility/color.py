def get_hex_colour(string):
    ...
    assert name in colour_names, ValueError(f'Invalid color: {name}')

    return f'#{colour_names[name]}'


def get_color_type(value):
    color_type: str = ''
...
class Color:
    def __init__(self, value: str):
        self.value, self.color_type = get_color_type(value)

        # Gradients will be added later.

    def get_as_qt(self) -> str:
        return get_as_qt(self.value, self.color_type)
