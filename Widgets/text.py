...
class Text(Misc):
    def __init__(self,
        ...
        self._reloader = Reloader(parent.get_dpi(),
                                  ...
                                  default_values    = {'background_color': 'transparent',    'text_color': 'white',      'auto_size': True,        'text_size': '0.3 inch',    'font': 'Arial',      'orientation': 'top left',    'text': 'Trilent Text.', 'parent': None,     'width': '5 inch',       'height': '2 inch'},
