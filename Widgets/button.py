...
QPushButton:pressed {{ background-color: {V}clicked_color{V}; }}"""
        ...
        self._reloader = Reloader(parent.get_dpi(),
                                  ...
                                  default_values    = {'hover_color': 'litecrimson', 'clicked_color': 'delightcrimson', 'command': lambda: ..., 'corner_roundness': '0.03 inch',      'button_color': 'crimson',    'text_color': 'white',      'text_size': '0.20 inch',   'font': 'Verdana',    'text': 'Trilent Button.', 'parent': None,     'width': '1.75 inch',    'height': '0.45 inch'},
